...
public class CraftrSound extends CraftrSoundShim implements Runnable
{
	...
	private static class CSSampleData
	{
		...
		public CSSampleData(String fname)
		{
			...
			try
			{
				...
				InputStream fp = CraftrSound.class.getResourceAsStream(fname);
	...
	{
		CraftrSound cs = new CraftrSound();
