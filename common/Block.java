...
public class Block
{
	...
	public Block(int ax, int ay)
	{
		this(ax,ay,0,0,0,0);
	}
	public Block(int ax, int ay, int at, int ach, int aco)
	{
		this(ax,ay,at,0,ach,aco);
	}
	public Block(int ax, int ay, int at, int ap, int ach, int aco)
	{
		x=ax;
		y=ay;
		block[0]=(byte)at;
	...
	public Block(int ax, int ay, byte[] bd)
	{
		x=ax;
		y=ay;
		block=bd;
