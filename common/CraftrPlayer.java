...
public class CraftrPlayer
{
	...
	public CraftrPlayer(int _px, int _py, byte _pchr, byte _pcol, String _pn)
	{
		px = _px;
		py = _py;
		pchr = _pchr;
	...
	public CraftrPlayer(int _px, int _py)
	{
		this(_px,_py,(byte)2,(byte)31,"You");
	}
	public CraftrPlayer(int _px, int _py, byte _pchr, byte _pcol)
	{
